...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox_pretty(
    KC_ESCAPE,      KC_1,           KC_2,           KC_3,           KC_4,           KC_5,           KC_LEFT,                                        KC_6,           KC_7,           KC_8,           KC_9,           KC_0,           KC_MINUS,       JA_HAT,
    KC_TAB,         KC_Q,           KC_W,           KC_E,           KC_R,           KC_T,           TG(1),                                          KC_BSPACE,      KC_Y,           KC_U,           KC_I,           KC_O,           KC_P,           JA_AT,
    KC_LCTL,        KC_A,           KC_S,           KC_D,           KC_F,           KC_G,                                                                           KC_H,           KC_J,           KC_K,           KC_L,           LT(2,KC_SCOLON),JP_COLN,
    KC_LSFT,        CTL_T(KC_Z),    KC_X,           KC_C,           KC_V,           KC_B,           KC_NO,                                          KC_NO,          KC_N,           KC_M,           KC_COMMA,       KC_DOT,         CTL_T(KC_SLASH),RSFT_T(JA_ENUN),
    LT(1,KC_GRAVE), KC_QUOTE,       LALT(KC_LSHIFT),KC_LALT,        LGUI_T(KC_LANG2),                                                                                               LT(1,KC_LANG1), JA_LBRC,        JA_RBRC,        JA_ENVL,        JA_ENUN,
                                                                                                    KC_LEFT,        KC_RIGHT,       KC_LALT,        CTL_T(KC_ESCAPE),
                                                                                                                    KC_UP,          KC_PGUP,
                                                                                    KC_SPACE,       KC_BSPACE,      KC_DOWN,        KC_PGDOWN,      KC_TAB,         KC_ENTER
  ),
  [1] = LAYOUT_ergodox_pretty(
    KC_ESCAPE,      KC_F1,          KC_F2,          KC_F3,          KC_F4,          KC_F5,          KC_TRANSPARENT,                                 KC_F6,          KC_F7,          KC_F8,          KC_F9,          KC_F10,         KC_F11,         KC_F12,
  ...
  [2] = LAYOUT_ergodox_pretty(
    ...
    RESET,          WEBUSB_PAIR,    KC_TRANSPARENT, KC_MS_BTN1,     KC_MS_BTN2,                                                                                                     KC_AUDIO_VOL_UP,KC_AUDIO_VOL_DOWN,KC_AUDIO_MUTE,  KC_TRANSPARENT, KC_TRANSPARENT,
